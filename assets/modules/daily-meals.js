...
#food-meals .meal-card-counts span{display:inline-flex;align-items:center;padding:5px 8px;border-radius:999px;font-size:10px;font-weight:850;white-space:nowrap}\
...
#food-meals .meal-card-total{display:inline-flex;align-items:center;flex-wrap:wrap;gap:4px 7px;margin-left:auto;padding:5px 9px;border-radius:999px;background:#e8f3fb;color:#557887;font-size:10px;font-weight:700}\
#food-meals .meal-card-total b{color:#17648a;font-size:10.5px}#food-meals .meal-card-total small{color:#6e8796;font-size:9px;font-weight:650}\
...
#food-meals .meal-card-more{margin-top:7px;padding:8px 9px;border-radius:11px;background:#f4f7f6;color:#55707a;font-size:9px;line-height:1.45}\
#food-meals .meal-card-more>b{display:block;color:#31586b;font-size:9.5px}#food-meals .meal-card-more ul{margin:4px 0 0;padding-left:16px}#food-meals .meal-card-more li{margin:2px 0}\
#food-meals .meal-card-budget{display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:6px;margin-top:7px;padding-top:7px;border-top:1px dashed rgba(80,127,142,.18);color:#6e8796;font-size:9px;font-weight:700}\
...
@media(min-width:760px){#food-meals .meal-card-counts span{font-size:11px}#food-meals .meal-card-total{font-size:11px}#food-meals .meal-card-total b{font-size:11.5px}#food-meals .meal-card-total small{font-size:10px}#food-meals .meal-card-grid{gap:12px}#food-meals .meal-card{padding:14px;border-radius:20px}#food-meals .meal-card header{gap:10px;padding-bottom:11px}#food-meals .meal-card header>span{width:48px;height:48px;border-radius:16px;font-size:16px}#food-meals .meal-card header b{font-size:15px}#food-meals .meal-card header small{font-size:11px;margin-top:3px}#food-meals .meal-card-row{grid-template-columns:auto minmax(0,1fr) auto;gap:9px;margin-top:8px;padding:9px 10px;border-radius:14px}#food-meals .meal-card-icon{width:28px;height:28px;border-radius:9px;font-size:15px}#food-meals .meal-card-copy strong{font-size:13px}#food-meals .meal-card-copy small{font-size:10.5px;line-height:1.4}#food-meals .meal-card-copy em{margin-top:4px;padding:3px 7px;font-size:10px}#food-meals .meal-card-status{grid-column:auto;justify-self:end;margin-top:0;padding:4px 7px;font-size:10px}#food-meals .meal-card-more{padding:9px 10px;font-size:10.5px}#food-meals .meal-card-more>b{font-size:11px}#food-meals .meal-card-budget{font-size:10.5px}#food-meals .meal-card-cost{padding:4px 7px}}\
